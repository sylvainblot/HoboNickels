...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 4444 or testnet: 14444)") + "\n" +
        ...
        "  -mininput=<amt>        " + _("When creating transactions, ignore inputs with value less than this (default: 0.001)") + "\n" +
#ifdef QT_GUI
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 3333 or testnet: 13333)") + "\n" +
